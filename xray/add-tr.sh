...
trojanlink="trojan://${uuid}@isi_bug_disini:${tls}?path=%2Ftrojanws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}"
trojanlink2="trojan://${uuid}@isi_bug_disini:${ntls}?path=%2Ftrojanws&security=none&host=${domain}&type=ws#${user}"
...
echo -e "Path           : /trojanws" | tee -a /etc/log-create-user.log
